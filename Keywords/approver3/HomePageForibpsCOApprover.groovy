...
public class HomePageForibpsSD_Approver {
	/*
	...
	def selectResistration() {
		...
		if(WebUI.waitForElementClickable(findTestObject("Object Repository/BackOffice/SDApprover/ibpsHomePage/SDApprover3"), 2)) {
			//clicking on encoder
			WebUI.click(findTestObject("Object Repository/BackOffice/SDApprover/ibpsHomePage/SDApprover3"))
